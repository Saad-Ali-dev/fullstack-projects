    ...
    <div className="bg-white dark:bg-gray-800 p-4 border-t border-gray-200 dark:border-gray-700 sticky bottom-0">
      <div className="container mx-auto flex items-end space-x-3">
        <textarea
          ...
          className="flex-grow p-3 border border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white text-sm max-h-40 overflow-y-auto"
          rows="1"
          disabled={isLoading}
